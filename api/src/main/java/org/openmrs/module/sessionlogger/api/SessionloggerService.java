 ...
 */
package org.openmrs.module.sessionlogger.api;
...
import org.openmrs.module.sessionlogger.SessionloggerConfig;
 ...
 */
public interface SessionloggerService extends OpenmrsService {
	...
	SessionLogger getItemByUuid(String uuid) throws APIException;
	 ...
	 * @throws APIException
	 */
	@Authorized(SessionloggerConfig.MODULE_PRIVILEGE)
	@Transactional
